...
const fetchPages = async () => {
  return await medusaClient.client.request(
    "GET",
    `/store/pages?tag=site-info&select=id,title,slug`
  )
}

const Footer = ({ storeData }: { storeData: any }) => {
        ...
        <div className="row">
          <div className="col-md-6 pb-4">
            ...
            <ul className="navbar-nav me-auto">
              {/* <li className="nav-item">
                <Link href="/faqs">
                  <a className="nav-link uppercase">FAQs</a>
                </Link>
              </li>
              <li className="nav-item">
                <Link href={"/return-policy"}>
                  <a className="nav-link uppercase">Return Policy</a>
                </Link>
              </li>
              <li className="nav-item">
                <Link href="/shipping-info">
                  <a className="nav-link uppercase">Shipping Infomation</a>
                </Link>
              </li> */}
              {pages?.map((page: any) => (
                <li key={page.id} className="nav-item">
                  <Link href={`/pages/${page.slug}`}>
                    <a className="nav-link uppercase">{page.title}</a>
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <div className="col-md-6 pb-4">
            ...
            <ul className="navbar-nav me-auto">
              ...
              {/* <li className="nav-item">
                <Link href="/about">
                  <a className="nav-link uppercase">About Us</a>
                </Link>
              </li>
              <li className="nav-item">
                <Link href="/contact">
                  <a className="nav-link uppercase">Cotact Us</a>
                </Link>
              </li>
              <li className="nav-item">
                <Link href="/term-of-service">
                  <a className="nav-link uppercase">Terms of Service</a>
                </Link>
              </li>
              <li className="nav-item">
                <Link href="/privacy-policy">
                  <a className="nav-link uppercase">Privacy Policy</a>
                </Link>
              </li> */}
            </ul>
          </div>
        ...
        <div className="row p-2 p-md-4">
          <div className="col-md-4">
            <p className="footer__copyright text-center text-md-start">
              © 2023 {storeData?.store_name}
            </p>
          </div>
          <div className="col-md-4 payment-icon text-center text-md-end inline-flex items-start justify-center gap-x-2">
            <Image
