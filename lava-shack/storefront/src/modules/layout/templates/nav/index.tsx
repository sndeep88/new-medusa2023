...
const Nav = ({ storeData }: { storeData?: any }) => {
    ...
    <header>
      ...
      >
        <div className="container-fluid">
          ...
          <div className="d-flex d-md-none w-[62px] h-8">
            <button
              className="pl-1 pr-1 border border-gray-200 rounded md:hidden self-auto"
              type="button"
              onClick={toggle}
            >
              <BarsIcon />
          ...
          <Link href="/">
            <a className="navbar-brand">
              {storeData && storeData.logo ? (
                <span className="relative block min-w-[200px] w-full md:min-w-full h-[75px] aspect-auto">
                  <Image
                    src={storeData.logo}
                    objectFit="contain"
                    layout="fill"
