...
const Items = ({ items, region, cartId }: ItemsProps) => {
  ...
  return (
    <div className="p-2.5 md:p-10 border-b border-gray-200 gap-y-4 flex flex-col">
                ...
                <div className="flex flex-col justify-between flex-1">
                  <div className="flex flex-col flex-1 text-small-regular">
                    <div className="flex items-start justify-between">
                      <div>
                        <h3 className="text-base-regular overflow-ellipsis overflow-hidden whitespace-pre-wrap mr-4">
                          <Link
