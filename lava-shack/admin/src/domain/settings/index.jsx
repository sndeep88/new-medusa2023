...
import FacebookPixel from "./social-tracking"
...
const SettingsIndex = () => {
  return (
    <SettingsOverview>
      ...
      />
      <SettingsCard
        heading="Social tracking"
        description="Manage your Social tracking"
        icon={<CrosshairIcon />}
        to={`/a/settings/pixels`}
      />
      <SettingsCard
        heading={"Shipping"}
...
const Settings = () => (
  <Routes className="h-full">
    ...
    <Route path="/pixels" element={<FacebookPixel />} />
